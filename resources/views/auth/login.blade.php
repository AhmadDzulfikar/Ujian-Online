...
<body>
    ...
    background-size: 100% 100%; background-attachment: fixed; opacity: 1;">
        <section class="section">
            <div class="container ">
                <div style="display: flex; ">
                    <div style="max-width: 50%;">
                        <div class="login-brand" style="display: flex; justify-content:start; align-items:center;">
                            <img src="/assets/img/logo10.jpeg" alt="logo" width="100" class="mt-3">
                            <div class="ml-3">
                                <div style="font-size: 25px;"><b>SMKN 10 JAKARTA</b></div>
                    ...
                    <div >
                        <div class="row" style="display: flex; justify-content:end;">
                            <div class=" col-xl-4 offset-xl-4">
                                <div class="card card-shadow" style="border-radius: 5%;">
